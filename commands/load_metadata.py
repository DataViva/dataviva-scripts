...
def metadata_command():
    attrs([
        ...
        {'name': 'cnes_altacomplexidade_hosp', 'csv_filename': 'cnes_high_complexity_hospitals.csv'},
        {'name': 'cnes_mediacomplexidade_hosp', 'csv_filename': 'cnes_medium_complexity_hospitals.csv'},
        {'name': 'cnes_internacao_hosp', 'csv_filename': 'cnes_hospitalization_hospitals.csv'},
        {'name': 'cnes_altacomplexidade_amb', 'csv_filename': 'cnes_high_complexity_ambulatories.csv'},
        {'name': 'cnes_mediacomplexidade_amb', 'csv_filename': 'cnes_medium_complexity_ambulatories.csv'},
        {'name': 'cnes_atencaobasica_amb', 'csv_filename': 'cnes_basic_attention_ambulatories.csv'},
        {'name': 'cnes_tipodeurgencia', 'csv_filename': 'cnes_urgency_type.csv'},
        {'name': 'cnes_tipodesadt', 'csv_filename': 'cnes_sadt_type.csv'},
        {'name': 'cnes_tipodeambulatorio', 'csv_filename': 'cnes_ambulatory_type.csv'},
        {'name': 'cnes_tipointernacao', 'csv_filename': 'cnes_hospitalization_type.csv'},
