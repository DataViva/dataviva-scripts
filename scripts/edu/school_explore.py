...
def main():
    ...
    print tech.columns
    # print tech.columns[0], 'YEAR'
    # print tech.columns[0] == u'YEAR'
    print tech.columns[1], 'ID_CLASS'
    print tech.columns[1] == 'ID_CLASS'
    sys.exit()
    
    # collapse a column
    tech = tech[[tech.columns[0], "ID_CLASS", "ID_COURSE", "ID_MUNICIPALITY", "ID_SCHOOL", "QTY_ENROLL"]]
