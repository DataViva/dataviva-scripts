...
CREATE TABLE `ei_ymsrp` (
  ...
  `month` int(2) NOT NULL,
  `bra_id_s` varchar(8) NOT NULL,
  `cnae_id_s` varchar(6) NOT NULL,
  `bra_id_r` varchar(8) NOT NULL,
  `cnae_id_r` varchar(5) NOT NULL,
  `hs_id` varchar(6) NOT NULL,

  `purchase_value` decimal(14,2) DEFAULT NULL,
  `transfer_value` decimal(14,2) DEFAULT NULL,
  `devolution_value` decimal(14,2) DEFAULT NULL,
  `icms_credit_value` decimal(14,2) DEFAULT NULL,
  `remit_value` decimal(14,2) DEFAULT NULL,
  `tax` decimal(14,2) DEFAULT NULL,
  `icms_tax` decimal(14,2) DEFAULT NULL,
  `transportation_cost` decimal(14,2) NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `ei_ymsp` (
 ...
 `month` int(2) NOT NULL,
 `bra_id_s` varchar(8) NOT NULL,
 `cnae_id_s` varchar(6) NOT NULL DEFAULT '',
 `hs_id` varchar(6) NOT NULL,
...
CREATE TABLE `ei_ymrp` (
  ...
  `month` int(2) NOT NULL,
  `bra_id_r` varchar(8) NOT NULL,
  `cnae_id_r` varchar(6) NOT NULL DEFAULT '',
  `hs_id` varchar(6) NOT NULL,
