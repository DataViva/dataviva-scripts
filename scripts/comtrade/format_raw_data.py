...
"""
    ...
    Example Usage
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    python scripts/comtrade/format_raw_data.py data/comtrade/comtrade_2014.csv -y 2014 -o data/comtrade/
...
def main(input_file, year, output_dir):
    ...
    new_ypw = ypw.merge(ypw_rca, how="outer", left_index=True, right_index=True) \
